...
const AboutMe = () => {
    return (
      <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-6 px-10 py-5 lg:px-20 lg:py-10 bg-[var(--light-color)] border border-[var(--light-color)] text-white w-full mx-auto">
