  ...
  return (
    <header className="fixed top-0 left-0 w-full grid grid-cols-3 items-center p-4 bg-[var(--light-color)] text-white shadow-lg">
      ...
      <div className="flex justify-end gap-4">
        <a href="https://github.com/VictorNguyen0702">
          <Button
              variant="outline"
              className="text-white border-white bg-[var(--dark-color)] hover:bg-[var(--dark-color)] hover:text-[var(--light-color)]">
              <Github className="w-5 h-5 mr-2"/>
              Github
          </Button>
        </a>
        <a href="https://www.linkedin.com/in/victor-nguyen-43123b26a/">
          <Button
              variant="outline"
              className="text-white border-white bg-[var(--dark-color)] hover:bg-[var(--dark-color)] hover:text-[var(--light-color)]">
